function Home() {
    {
        return (
            <div>
                ...
                <ul>
                    <li><a href='src/Components/Home'>ASP.NET Core</a> and <a
                        href='https://msdn.microsoft.com/en-us/library/67ef8sbd.aspx'>C#</a> for cross-platform
                        server-side code
                    </li>
                    <li><a href='src/Components/Home'>React</a> for client-side code</li>
                    <li><a href='src/Components/Home'>Bootstrap</a> for layout and styling</li>
                </ul>
